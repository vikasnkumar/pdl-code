...
PDL::Bad - PDL can be built to process bad values or not.

=head1 DESCRIPTION

The contents of Bad.pm depend on whether we have
bad-value support in PDL. This POD file will document the behaviour of the
functions when Bad value support is turned or off.
...
=head1 DOCUMENTATION - PDL WITHOUT BAD VALUE SUPPORT
